...
namespace PicoShot.Localization.Config
{
    ...
    public class LocalizationConfig : ScriptableObject
    {
        ...
        [Header("Typed Keys")]
        [Tooltip("Generate strongly typed StringKeys and ArrayKeys enums when language data is saved")]
        [SerializeField]
        private bool _generateTypedKeys = false;
        ...
        /// <summary>
        /// Whether strongly typed localization key enums are generated by the editor.
        /// </summary>
        public bool GenerateTypedKeys => _generateTypedKeys;
        ...
        public void SetGenerateTypedKeys(bool enabled)
        {
            if (_generateTypedKeys == enabled) return;
            _generateTypedKeys = enabled;
            UnityEditor.EditorUtility.SetDirty(this);
        }
